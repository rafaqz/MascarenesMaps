...
function define_map_files(; 
    ...
    file_details = (mus=(;
        ...
        # )
        native = "$path/Data/Generated/reu_all_natives.tif" => 
            ["native_remnant"] => (;
        ...
        # urban_1885 = "/home/raf/PhD/Mascarenes/Data/Selected/Rodrigues/rodrigues-mauritius-mascarene-islands-mascarenhas-archipelago-1885-GC0ATP.jpg" => 
        #   _get_categories => (;
        #     urban=1885 => "urban",
        # ),
        gade_1 = "$path/Data/Selected/Rodrigues/Gade_1985_landcover.png" => 
            ["native_remnant"] => (;
                native = [1700 => :mask, 1985 => :force => "native_remnant"],
            ),
        gade_2 = "$path/Data/Selected/Rodrigues/Gade_1985_landcover_2.png" => 
        ...
        homiisland = "$path/Data/Generated/Landcover/rod_landcover.tif" => 
            HOMI_CLASSES => (;
                native=2017 => ["Forest"],
        ...
        rural_development_planning = "/home/raf/PhD/Mascarenes/Data/Selected/Rodrigues/cb5989en.png-06_colored.png" => 
